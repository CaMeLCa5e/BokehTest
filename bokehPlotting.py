...
# #prepare data 
# x = [1,2,3,4,5,5, 8, 90, 12, 44]
# y = [7,8,4,3,7,8, 9,4,2,33,3,6,8,0]
x0 = [1,2,3,4,5]
y1 = [x**2 for x in x0]
y2 = [10**x for x in x0]
y3 = [10**(x**2) for x in x0]

#output to static HTML output_file
output_file("lines.html", title="line plot example")

#plot a 'line' renderer setting the color, line thickness and legend value
...
"""
notes - saving to lines.html for data storage? does this create lines.1.html for a second run? (file is overwritten)

Why is this importing numpy if np is not called in the script?  
